...
public class RuntimeCoreInstanceFactory extends BaseM3CoreInstanceFactory
{
    @Override
    public boolean supports(String classifierPath)
    {
        return RuntimeCoreInstanceFactoryRegistry.REGISTRY.getFactoryForPath(classifierPath) != null;
    }
    ...
    {
        org.finos.legend.pure.m4.coreinstance.factory.CoreInstanceFactory factory = RuntimeCoreInstanceFactoryRegistry.REGISTRY.getFactoryForPath(getClassifierPath(classifier));
        if (factory != null)
        {
