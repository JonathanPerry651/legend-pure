...
public class CoreGen extends CoreHelper {
    public static final Bridge bridge = new Bridge() {
        ...
        public LambdaCompiledExtended buildLambda(
                org.finos.legend.pure.m3.coreinstance.meta.pure.metamodel.function.LambdaFunction<Object> lambdaFunction,
    ...
    public static Object evaluateToMany(ExecutionSupport es, Function<?> func,
            RichIterable<? extends List<?>> instances) {
    ...
    private static Object dynamicMatch(Object obj, RichIterable<Function<?>> funcs, Object var, boolean isMatchWith,
            ExecutionSupport es) {
        return Pure.dynamicMatch(obj, funcs, var, isMatchWith, bridge, es);
    }

    public static <T, V> RichIterable<T> removeDuplicates(RichIterable<T> list, Function<?> keyFn, Function<?> eqlFn,
            ExecutionSupport es) {
        return Pure.removeDuplicates(list, keyFn, eqlFn, bridge, es);
    }

    public static boolean canReactivateWithoutJavaCompilation(ValueSpecification valueSpecification,
            ExecutionSupport es) {
        return Pure.canReactivateWithoutJavaCompilation(valueSpecification, es, new PureMap(Maps.mutable.empty()),
                bridge);
    }

    public static boolean canReactivateWithoutJavaCompilation(ValueSpecification valueSpecification,
            ExecutionSupport es, PureMap lambdaOpenVariablesMap) {
        return Pure.canReactivateWithoutJavaCompilation(valueSpecification, es, lambdaOpenVariablesMap, bridge);
    }

    public static Object newObject(Class<?> aClass, String name, RichIterable<? extends KeyExpression> keyExpressions,
            ExecutionSupport es) {
    ...
    public static String format(String formatString, Object formatArgs, ExecutionSupport es) {
        return CompiledSupport.format(formatString, formatArgs,
    ...
    public static String toRepresentation(Object any, ExecutionSupport es) {
        return org.finos.legend.pure.generated.platform_pure_essential_string_toString_toRepresentation
                .Root_meta_pure_functions_string_toRepresentation_Any_1__String_1_(any, es);
    }

    public static RichIterable<? extends KeyValue> processKeyExpressions(java.lang.Class<?> _class, Object instance,

            RichIterable<?> keyExpressions, ExecutionSupport es) {
        MutableList<KeyValue> result = Lists.mutable.empty();
        MutableSet<String> keys = Sets.mutable.empty();
        for (Object item : keyExpressions) {
    ...
    public static Object newObject(final Class<?> aClass, java.lang.Iterable keyExpressions,
        ...
        try {
            ...
            org.finos.legend.pure.m3.navigation.PackageableElement.PackageableElement
                    .writeUserPathForPackageableElement(builder, aClass);
        ...
        keyExpressions.forEach(new DefendedProcedure<Object>() {
            @Override
            public void value(Object item) {
                ...
                try {
                    ...
                    Throwable cause = (e instanceof InvocationTargetException) ? e.getCause() : e;
                    StringBuilder builder = new StringBuilder("Error setting property '").append(keyValue._key())
                            .append("' for instance of ");
                    org.finos.legend.pure.m3.navigation.PackageableElement.PackageableElement
                            .writeUserPathForPackageableElement(builder, aClass);
                    String eMessage = cause.getMessage();
                    if (eMessage != null) {
        ...
        PureFunction2Wrapper getterToOneExecFunc = getterToOneExec == null ? null
                : new PureFunction2Wrapper(getterToOneExec, es);
        PureFunction2Wrapper getterToManyExecFunc = getterToManyExec == null ? null
                : new PureFunction2Wrapper(getterToManyExec, es);
        ElementOverride elementOverride = override;
        if (override instanceof GetterOverride) {
            elementOverride = ((GetterOverride) elementOverride)._getterOverrideToOne(getterToOne)
                    ._getterOverrideToMany(getterToMany)._hiddenPayload(payload);
    ...
    public static Object newObject(GenericType genericType,
            ...
            ExecutionSupport es) {
        return newObject((Class<?>) genericType._rawType(), root_meta_pure_functions_lang_keyExpressions, override,
                getterToOne, getterToMany, payload, getterToOneExec, getterToManyExec, es);
    }

    public static PureMap newMap(RichIterable<? extends Pair<?, ?>> pairs,
            RichIterable<? extends Property<?, ?>> properties, ExecutionSupport es) {
    ...
    public static <U, V> RichIterable<Pair<U, V>> zip(Object l1, Object l2,
            Function0<? extends Pair<U, V>> pairBuilder) {
        return zipImpl((RichIterable<? extends U>) l1, (RichIterable<? extends V>) l2, pairBuilder);
    }

    public static <U, V> RichIterable<Pair<U, V>> zip(RichIterable<? extends U> l1, RichIterable<? extends V> l2,
            final Function0<? extends Pair<U, V>> pairBuilder) {
        return zipImpl(l1, l2, pairBuilder);
    }

    private static <U, V> RichIterable<Pair<U, V>> zipImpl(RichIterable<? extends U> l1, RichIterable<? extends V> l2,
            final Function0<? extends Pair<U, V>> pairBuilder) {
        return (l1 == null) || (l2 == null) ? Lists.immutable.<Pair<U, V>>empty()
                : l1.zip(l2).collect(
                        new DefendedFunction<org.eclipse.collections.api.tuple.Pair<? extends U, ? extends V>, Pair<U, V>>() {
                            @Override
                            public Pair<U, V> valueOf(
                                    org.eclipse.collections.api.tuple.Pair<? extends U, ? extends V> pair) {
                                return pairBuilder.value()._first(pair.getOne())._second(pair.getTwo());
                            }
                        });
    }

    public static Object dynamicMatchWith(Object obj, RichIterable<Function<?>> funcs, Object var,
            ExecutionSupport es) {
    ...
    public static Object reactivate(ValueSpecification valueSpecification, PureMap lambdaOpenVariablesMap,
            ExecutionSupport es) {
        return Pure.reactivate(valueSpecification, lambdaOpenVariablesMap, true, CoreGen.bridge, es);
    }

    public static Object reactivate(ValueSpecification valueSpecification, PureMap lambdaOpenVariablesMap,
            boolean allowJavaCompilation, ExecutionSupport es) {
    ...
    public static boolean assertError(ExecutionSupport es, Function<?> func, String message, long line, long column,
        ...
        try {
            ...
            if ((message != null) && !message.equals(e.getInfo())) {
                throw new PureAssertFailException(sourceInformation,
            ...
            if ((line != -1) && (e.getSourceInformation().getLine() != line)) {
                throw new PureAssertFailException(sourceInformation, "Execution error line mismatch. Actual: "
                        + e.getSourceInformation().getLine() + " where expected: " + line);
            }
            if ((column != -1) && (e.getSourceInformation().getColumn() != column)) {
                throw new PureAssertFailException(sourceInformation, "Execution error column mismatch. Actual: "
                        + e.getSourceInformation().getColumn() + " where expected: " + column);
            }
        }
        return true;
    }
